...
function App() {
  ...
  return <div className="site-shell"><div ref={cursorRef} className="custom-cursor" aria-hidden="true"><span /></div>
    ...
    <main>
      ...
      <section id="contact" className="contact section-frame dark-section"><div className="section-kicker light"><span>005</span><span>START HERE</span></div><p className="eyebrow light"><span className="eyebrow-dot"/> READY WHEN YOU ARE</p><h2>Make science<br/><em>make sense.</em></h2><a className="contact-cta" href="mailto:hello@physichem.in">TALK TO US <ArrowUpRight size={19}/></a><footer><span>© 2024 PHYSICHEM</span><div><a href="#home">INSTAGRAM</a><a href="#home">YOUTUBE</a></div><span>CLASSES 09—12</span><small>MADE AND DESIGNED BY HASIB MALLICK</small></footer></section>
    </main>
